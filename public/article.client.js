...
function encapsulateStyles(node) {
	setAttribute(node, "svelte-4207723127", "");
}

function create_main_fragment(state, component) {
	var meta, text, title, text_1, text_3, d_front_matter, script, text_4, text_6, d_title, h1, text_7, text_8, text_9, text_10, p, text_11, text_13, d_byline, text_14, d_article, p_1, text_15, text_17, d_appendix;
	...
	return {
		c: function create() {
			...
			h1 = createElement("h1");
			text_7 = createText("Hello ");
			text_8 = createText(state.$message);
			text_9 = createText("!");
			text_10 = createText("\n\t");
			p = createElement("p");
			text_11 = createText("Introduction");
			text_13 = createText("\n");
			d_byline = createElement("d-byline");
			text_14 = createText("\n");
			d_article = createElement("d-article");
			p_1 = createElement("p");
			text_15 = createText("This is the article");
			text_17 = createText("\n");
		...
		l: function claim(nodes) {
			...
			text_7 = claimText(h1_nodes, "Hello ");
			text_8 = claimText(h1_nodes, state.$message);
			text_9 = claimText(h1_nodes, "!");
			h1_nodes.forEach(detachNode);
			text_10 = claimText(d_title_nodes, "\n\t");

			p = claimElement(d_title_nodes, "P", {}, false);
			var p_nodes = children(p);

			text_11 = claimText(p_nodes, "Introduction");
			...
			text_15 = claimText(p_1_nodes, "This is the article");
		...
		m: function mount(target, anchor) {
			...
			appendNode(text, document.head);
			appendNode(title, document.head);
			appendNode(text_1, title);
			insertNode(text_3, target, anchor);
			insertNode(d_front_matter, target, anchor);
			appendNode(script, d_front_matter);
			appendNode(text_4, script);
			insertNode(text_6, target, anchor);
			insertNode(d_title, target, anchor);
			appendNode(h1, d_title);
			appendNode(text_7, h1);
			appendNode(text_8, h1);
			appendNode(text_9, h1);
			appendNode(text_10, d_title);
